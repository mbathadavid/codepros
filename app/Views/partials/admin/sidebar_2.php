         ...
         <ul class="navbar-nav flex-column" id="sideNavbar">
             ...
             <li class="nav-item">
                 ...
                 <div id="navDashboard" class="collapse  show " data-bs-parent="#sideNavbar">
                     <ul class="nav flex-column">
                         ...
                         <li class="nav-item">
                             <a class="nav-link " href="https://dashui.codescandy.com/dashuipro/index.html">
                                 Project </a>
                         </li>
             ...
             <li class="nav-item">
                 ...
                 <div id="navecommerce" class="collapse " data-bs-parent="#sideNavbar">
                     <ul class="nav flex-column">
                         ...
                         <li class="nav-item">
                             <a class="nav-link has-arrow " href="ecommerce-products.html">

                                 Products
                             </a>
                         </li>
                         <li class="nav-item">
                             <a class="nav-link has-arrow " href="ecommerce-products-details.html">

                                 Product Detail
                             </a>
                         </li>
                         <li class="nav-item">
                             <a class="nav-link has-arrow " href="ecommerce-product-edit.html">

                                 Add Product
                             </a>
                         </li>
                         <li class="nav-item">
                             <a class="nav-link has-arrow " href="ecommerce-order-list.html">

                                 Orders
                             </a>
                         </li>
                         <li class="nav-item">
                             <a class="nav-link has-arrow " href="ecommerce-order-detail.html">

                                 Orders Detail
                             </a>
                         </li>
                         <li class="nav-item">
                             <a class="nav-link has-arrow " href="ecommerce-cart.html">

                                 Shopping cart
                             </a>
                         </li>
                         <li class="nav-item">
                             <a class="nav-link has-arrow " href="ecommerce-checkout.html">

                                 Checkout
                             </a>
                         </li>
                         <li class="nav-item">
                             <a class="nav-link has-arrow " href="ecommerce-customer.html">

                                 Customer
                             </a>
                         </li>
                         <li class="nav-item">
                             <a class="nav-link has-arrow " href="ecommerce-seller.html">
             ...
             <li class="nav-item">
                 ...
                 <div id="navEmail" class="collapse " data-bs-parent="#sideNavbar">
                     <ul class="nav flex-column">
                         <li class="nav-item">
                             <a class="nav-link has-arrow " href="mail.html">

                                 Inbox
                             </a>
                         </li>
                         <li class="nav-item">
                             <a class="nav-link has-arrow " href="mail-details.html">

                                 Details
                             </a>
                         </li>
                         <li class="nav-item">
                             <a class="nav-link has-arrow " href="mail-draft.html">
             ...
             <li class="nav-item">
                 ...
                 <div id="navKanban" class="collapse " data-bs-parent="#sideNavbar">
                     <ul class="nav flex-column">
                         <li class="nav-item">
                             <a class="nav-link has-arrow " href="task-kanban-grid.html">

                                 Grid
                             </a>
                         </li>
                         <li class="nav-item">
                             <a class="nav-link has-arrow " href="task-kanban-list.html">
             ...
             <li class="nav-item">
                 ...
                 <div id="navCRM" class="collapse " data-bs-parent="#sideNavbar">
                     <ul class="nav flex-column">
                         ...
                         <li class="nav-item">
                             <a class="nav-link has-arrow " href="crm-contacts.html">

                                 Contacts
                             </a>
                         </li>
                         <li class="nav-item">
                             <a class="nav-link has-arrow " href="crm-company.html">
             ...
             <li class="nav-item">
                 ...
                 <div id="navinvoice" class="collapse " data-bs-parent="#sideNavbar">
                     <ul class="nav flex-column">
                         ...
                         <li class="nav-item">
                             <a class="nav-link has-arrow " href="invoice-list.html">

                                 List
                             </a>
                         </li>
                         <li class="nav-item">
                             <a class="nav-link has-arrow " href="invoice-detail.html">

                                 Detail
                             </a>
                         </li>
                         <li class="nav-item">
                             <a class="nav-link has-arrow " href="invoice-generator.html">
             ...
             <li class="nav-item">
                 ...
                 <div id="navblog" class="collapse " data-bs-parent="#sideNavbar">
                     <ul class="nav flex-column">
                         ...
                         <li class="nav-item">
                             <a class="nav-link has-arrow " href="blog-author.html">

                                 Author
                             </a>
                         </li>
                         <li class="nav-item">
                             <a class="nav-link has-arrow " href="blog-author-detail.html">

                                 Detail
                             </a>
                         </li>
                         <li class="nav-item">
                             <a class="nav-link has-arrow " href="create-blog-post.html">
             ...
             <li class="nav-item">
                 <a class="nav-link has-arrow  collapsed " href="#!" data-bs-toggle="collapse" data-bs-target="#navLayouts" aria-expanded="false" aria-controls="navLayouts">
                 ...
                 <div id="navLayouts" class="collapse " data-bs-parent="#sideNavbar">
                     <ul class="nav flex-column">
                         <li class="nav-item">
                             <a class="nav-link  " href="https://dashui.codescandy.com/dashuipro/index.html"> Default</a>
                         </li>

                         <li class="nav-item">
                             <a class="nav-link " href="https://dashui.codescandy.com/dashuipro/horizontal/index.html">
                                 Horizontal</a>
                         </li>
             ...
             <li class="nav-item">
                 ...
                 <div id="navDocs" class="collapse " data-bs-parent="#sideNavbar">
                     <ul class="nav flex-column">
                         ...
                         <li class="nav-item"><a href="https://dashui.codescandy.com/dashuipro/docs/index.html" class="nav-link  ">Introduction</a></li>
                         <li class="nav-item"><a href="https://dashui.codescandy.com/dashuipro/docs/environment-setup.html" class="nav-link ">Environment setup</a></li>
                         <li class="nav-item"><a href="https://dashui.codescandy.com/dashuipro/docs/working-with-gulp.html" class="nav-link  ">Working with Gulp</a>
                         </li>
                         <li class="nav-item"><a href="https://dashui.codescandy.com/dashuipro/docs/compiled-files.html" class="nav-link ">Compiled Files</a>
                         </li>
                         <li class="nav-item"><a href="https://dashui.codescandy.com/dashuipro/docs/file-structure.html" class="nav-link ">File Structure</a></li>
                         <li class="nav-item"><a href="https://dashui.codescandy.com/dashuipro/docs/resources-assets.html" class="nav-link ">Resources & assets</a></li>
                         <li class="nav-item"><a href="https://dashui.codescandy.com/dashuipro/docs/changelog.html" class="nav-link ">Changelog</a></li>
