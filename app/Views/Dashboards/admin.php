            ...
            <div class="col-lg-12 col-md-12 col-12">
                <div class="p-6 d-lg-flex justify-content-between align-items-center ">
                    <div class="d-md-flex align-items-center">
                        <img src="<?php echo base_url() ?>/assets/admin/images/avatar/avatar-3.jpg" alt="Image" class="rounded-circle avatar avatar-xl">
            ...
            <div class="card h-100">
                ...
                <div class="card-body p-0">
                    ...
                    <table class="table mb-0">
                        <tbody>
                            <tr>
                                <td class="border-top-0 "> <img src="https://dashui.codescandy.com/dashuipro/assets/images/svg/browser-svg/chrome.svg" alt="Image" class="me-2"><span>Google
                                        Chrome</span></td>
                                <td class="text-end border-top-0  ">21.54%</td>

                            </tr>
                            <tr>
                                <td> <img src="https://dashui.codescandy.com/dashuipro/assets/images/svg/browser-svg/firefox.svg" alt="Image" class="me-2"><span>Mozilla
                                        Firefox</span></td>
                                <td class="text-end  ">14.43%</td>

                            </tr>
                            <tr>
                                <td> <img src="https://dashui.codescandy.com/dashuipro/assets/images/svg/browser-svg/brave.svg" alt="Image" class="me-2"><span>Brave</span></td>
                                <td class="text-end  ">14.43%</td>

                            </tr>
                            <tr>
                                <td> <img src="https://dashui.codescandy.com/dashuipro/assets/images/svg/browser-svg/safari.svg" alt="Image" class="me-2"><span>Apple
                                        Safari</span></td>
                            ...
                            <tr>
                                <td> <img src="https://dashui.codescandy.com/dashuipro/assets/images/svg/browser-svg/ie.svg" alt="Image" class="me-2"><span>Internet Export</span>
                                </td>
                                <td class="text-end  ">6.21%</td>

                            </tr>
                            <tr>
                                <td> <img src="https://dashui.codescandy.com/dashuipro/assets/images/svg/browser-svg/opera.svg" alt="Image" class="me-2"><span>Opera
                                        Mini</span></td>
                                <td class="text-end  ">8%</td>

                            </tr>
                            <tr>
                                <td> <img src="https://dashui.codescandy.com/dashuipro/assets/images/svg/browser-svg/microsoft-edge.svg" alt="Image" class="me-2"><span>Microsoft edge</span></td>
